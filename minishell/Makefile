...
LIBS_MAC	=	-L/Users/${USER}/.brew/opt/readline/lib -L/usr/local/opt/readline/lib

INCLUDE		=	-I/Users/${USER}/.brew/opt/readline/include -I/usr/local/opt/readline/include -I./srcs/ -I./libft/srcs/
